 ...
 */
export const getTool = (toolName: ToolName, context: ToolContext = {}) => createToolDefinitions(context)[toolName]
 ...
 */
export const getAllTools = (context: ToolContext = {}) => createToolDefinitions(context)
