...
// async function useDeployContract():Promise<DeployContractResponse> {

//     const { chain } = useNetwork();
//     const viemChain = chain?.name && createViemChain(chain.name)

//     const [deploymentData, setDeploymentData] = useState<DeployContractResponse>()

//     const { data: walletClient, isError, isLoading } = useWalletClient()

//     viemChain && walletClient && deployContract({
