...
export const functionSchemas: ChatCompletionFunctions[] = [
  ...
  },
  {
    ...
    description:
      'Deploy a smart contract and tries to verify the code on the block explorer.',
    parameters: {
      type: 'object',
      description:
      ...
      properties: {
        ...
        chainName: {
          type: 'string',
          description:
            'Name of the EVM compatible chain we are deploying to.  Default to Mantle Testnet if not specified.'
        },
        sourceCode: {
          type: 'string',
          description:
